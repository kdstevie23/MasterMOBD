...
class EmojiCollectionViewController: UICollectionViewController {
    ...
    var emojis: [Emoji] = [
        ...
        Emoji(symbol: "🍝", name: "Spaghetti", description: "NOODLES", usage: "spaghetti"),
        Emoji(symbol: "🎲", name: "Die", description: "A single die.", usage: "taking a risk, chance; game"),
        Emoji(symbol: "⛺️", name: "Tent", description: "tent.", usage: "camping"),
        Emoji(symbol: "📚", name: "BOOKS", description: "NOBODY LIKES THESE", usage: "WANTING TO DIE"),
        Emoji(symbol: "💔", name: "A Broken Heart", description: "MY HEART AFTER U SMASH IT W A HAMMER", usage: "SADNESS EVER AFTER"),
        Emoji(symbol: "💤", name: "Snore", description: "Three blue \'z\'s.", usage: "tired, sleepiness"),
        Emoji(symbol: "🏁", name: "Checkered Flag", description: "WIN THE RACE BB", usage: "completion")
    ]
